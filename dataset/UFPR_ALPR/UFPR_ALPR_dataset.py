...
class UFPR_ALPR_dataset(Dataset):
    def __init__(self, data_path=None, dataset_type="__train", crop_plate=True, index_maximum=None, transform=None, download=False):
        if data_path is None:
            data_path = os.getcwd()
        self.data_path = data_path
        dataset_type = dataset_type.lower()
        if dataset_type == "__train":
    ...
    #     training_set = (
    #         read_image_file(
    #             os.path.join(self.raw_folder, "__train-images-idx3-ubyte")
    #         ),
    #         read_label_file(
    #             os.path.join(self.raw_folder, "__train-labels-idx1-ubyte")
    #         ),
    #     )
    #     test_set = (
    #         read_image_file(
    ...
    def get_file_paths(self):
        # TODO! split __train, valid, test sets
...
if __name__ == "__main__":
    ...
    index_maximum = 5
    parser = UFPR_ALPR_dataset(data_path=data_path, dataset_type="__train", crop_plate=True, index_maximum=index_maximum)  # , index_maximum=index_maximum
    # print(parser[0])
